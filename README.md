...
- Go extraction through a Node-hosted Go AST analyzer, package-local companion graph edges, package-scoped `go list -json` action identity, and single-file `go build` / `go test` feedback.
