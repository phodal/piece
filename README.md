...
- Generated `.pic` metadata, package-view-aware override merging, and an ANTLR-backed JVM parser for the same package, target, action, artifact, and per-target source model.
