...
- A language-neutral `feedbackScope` explanation that reports whether feedback is handled at piece, file, source-set, or project level. Unknown edges, top-level effects, slice safety flags, and Gradle project-model fallback all become documented reasons, and generated action inputs plus snapshot and runtime-cache hashes include source, dependency, and fallback-scope identity.
