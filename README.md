...
- Generated `.pic` metadata, Node-side analysis-level override merging, package-view-aware override bases, and an ANTLR-backed JVM parser for the same package, target, action, artifact, and per-target source model.
