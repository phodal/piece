...
- declaration graphs and default packages are still single-file first, while selected toolchain scopes can include same-package companion files and expose candidate package-scope targets;
